...
public class MatriculaInfrastructureTests : TestBase
{
    ...
    Arquivo? laudo = null)
    {
        ...
        id: 0, aluno: aluno, plano: plano, dataInicio: inicio, objetivo: "Renata Amabile Basquerote", restricoesMedicas: restricoes, laudoMedico: laudo, observacoesRestricoes: obsRestricao
        );
    ...
    public async Task Matricula_Adicionar_E_ObterPorId_Sucesso()
    {
        ...
        Assert.Equal("MySQL", obtida.ObservacoesRestricoes);
