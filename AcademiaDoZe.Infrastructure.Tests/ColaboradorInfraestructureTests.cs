...
public class ColaboradorInfrastructureTests : TestBase
{
    ...
    internal static async Task<Colaborador> CriarEInserirColaboradorAsync(ColaboradorRepository colaboradorRepo, LogradouroRepository logradouroRepo, AcademiaDoZe.Infrastructure.Data.DatabaseType databaseType)
    {
        ...
        id: 0,
        nome: "Renata Amabile " + Guid.NewGuid().ToString("N")[..5],
        cpf: GerarCpf(),
