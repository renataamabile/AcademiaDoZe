...
[DebuggerDisplay("{nameof(ValueObjectsTests),nq}")]
public class ValueObjectsTests
{
    ...
    [InlineData(null)]
    [InlineData("")]
    public void Deve_Falhar_Criacao_Quando_SenhaObrigatoria(string? input)
    {
    ...
    [Theory(DisplayName = "Cpf: quantidade de dígitos inválida")]
    [InlineData("123456789")]
    [InlineData("123456789012")]
    public void Deve_Falhar_Criacao_Quando_CpfPossuiQuantidadeDigitosInvalida(string input)
    {
        var result = Cpf.Criar(input);
    ...
    public void Deve_Falhar_Criacao_Quando_TelefonePossuiQuantidadeDigitosInvalida(string input)
    {
        var result = Telefone.Criar(input);
