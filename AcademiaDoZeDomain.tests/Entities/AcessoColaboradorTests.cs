...
public class AcessoColaboradorTests
{
    ...
    [Fact(DisplayName = "AcessoColaborador: deve aceitar acesso exatamente às 06:00")]
    ...
    [Fact(DisplayName = "AcessoColaborador: deve aceitar acesso exatamente às 22:00")]
    ...
    [Fact(DisplayName = "AcessoColaborador: deve falhar quando colaborador for nulo")]
    public void Deve_Falhar_Quando_Colaborador_ForNulo()
    {
        var result = AcessoColaborador.Criar(
            1,
            null!,
    ...
    [Fact(DisplayName = "AcessoColaborador: deve falhar antes das 06:00")]
    public void Deve_Falhar_Quando_Acesso_ForAntesDas06Horas()
    {
        var colaborador = Colaborador.Criar(
            1,
            "Colaborador Teste",
        ...
        var dataHora = DateTime.Today.AddHours(5).AddMinutes(59);
    ...
    [Fact(DisplayName = "AcessoColaborador: deve falhar depois das 22:00")]
    public void Deve_Falhar_Quando_Acesso_ForDepoisDas22Horas()
    {
        var colaborador = Colaborador.Criar(
            1,
            "Colaborador Teste",
        ...
        var dataHora = DateTime.Today.AddHours(22).AddMinutes(1);
